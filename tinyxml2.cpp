    ...
    _buffer()
{
    ...
    if (printDialect == PRINT_DIALECT_VISUALSTUDIO) {
        _entityFlag[static_cast<unsigned char>('\'')] = false;
        _entityFlag[static_cast<unsigned char>('\"')] = false;
        _restrictedEntityFlag[static_cast<unsigned char>('\r')] = true;
...
{
    PrepareForNewNode( _printDialect == PRINT_DIALECT_COMPACT );
